...
class IntegrationStatusTest(unittest.TestCase):
    @staticmethod
    def _status(available: dict[str, str], version: str = "0.16.3") -> dict[str, object]:
        ...
        def distribution(name: str) -> str | None:
            return {"simplicio-mapper": "0.24.2", "simplicio-cli": version}.get(name)
    ...
    def test_below_minimum_dev_cli_remains_fail_closed(self) -> None:
        ...
        self.assertEqual("0.16.3", status["dev_cli"]["minimum"])
