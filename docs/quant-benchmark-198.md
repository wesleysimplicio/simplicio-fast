...
The default bounded run measures 10,000 vectors and emits `null` plus
`CAPACITY_LIMIT_CONFIGURED` for 100,000 and 1,000,000. Increase
...
3. Serialized index reduction reaches the configured minimum.
