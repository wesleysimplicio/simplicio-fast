...
| #241 | PARTIAL | `7be3c94`; `issue241-windows-20260802-30.json` with 30-run binary/JSON/journal/Dev CLI receipt; installed console materialization and lifecycle tests pass (4 tests) | Linux/Windows byte parity, all operations, recovery/adversarial matrix and final coverage |
