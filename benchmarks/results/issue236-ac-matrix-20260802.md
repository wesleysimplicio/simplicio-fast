...
| --- | --- | --- | --- |
| #236 | PARTIAL | Full suite: 653 tests + 67 subtests passed on Windows after explicit stdin/file-backed subprocess hardening in `cd0867f`; release-integrity pass; receipts below | Final AC matrix, full coverage, Linux/Windows assets, 10 worktrees/20 readers, installed S3/S4/S5 delivery |
