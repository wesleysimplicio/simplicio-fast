...
owned by an external capability or service. Current master is `2c09ea2`;
...
| #339 | PARTIAL | `4436e90`; typed `simplicio.fast.projection/v1` envelope plus Code/Knowledge/Operations producers, scoped incremental store, atomic persistence, installed smoke and `issue339-windows-cross-domain-20260802-30.json` (30 raw repetitions, 20 readers, 10 consumers) | Rust parity and canonical-baseline comparison |
